...
To check / view the .glb files I've used: https://gltf-viewer.donmccurdy.com/ and https://github.khronos.org/glTF-Sample-Viewer-Release/
...
## Controls:
- moving around with the WASD Keys
- left click anywhere, then use mouse left- or rightclick to look around 
- you go down using the Q key and up using the E key

## problems / bugs / ideas
- lighting
- textures went missing (pink),invisible or corrupted after export to .glb
- there's only a few maps available, adding more maps
